...
<div class="half column"><div class="cell" style="background-image:url('images/new-ivory-bg-main-image.jpg');"><div class="inner"></div></div></div>
    ...
    <section id="result" class="intro white"><h3>result</h3><h4 class="underline">well, did it work?</h4><nav  id="categories" role="navigation"><ul><li><a href="">Brand Strategy</a></li><li><a href="" class="print">Print</a></li><li><a href="" class="direct-marketing">Direct Marketing</a></li></ul></nav>
